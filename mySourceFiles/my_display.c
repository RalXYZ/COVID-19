...
void InitColor()
{
	InputMyColors(0, "苍松", 0x203227, 0x637B6D, 0x9CC2AD, 0x8EAC4A, 0xB0DCD2, 0x76BEAD, 0x269F77);
	InputMyColors(1, "红豆", 0xB9B2B4, 0x1B121F, 0x7A0B0E, 0x9A5C5C, 0xCF4141, 0x6AA40C, 0x4B4B4B);
	InputMyColors(2, "蔷薇", 0x312E31, 0xFFB6B9, 0xFF5F7F, 0xEF8D8D, 0xD69EA7, 0xD0CBCB, 0xB4B4B4);
	InputMyColors(3, "万圣节", 0x1C162B, 0xB94E0A, 0xC38112, 0xC46C6C, 0xF08649, 0xF0BB49, 0xE7D7D0);
	InputMyColors(4, "熊猫", 0x222222, 0x828282, 0xEAEAEA, 0xEFD1D1, 0xB96666, 0x76BEAD, 0x732424);
	InputMyColors(5, "蓝鹊", 0xC9D1D9, 0x4780BA, 0xBA5255, 0xDB8177, 0x5283B5, 0x7CAAE7, 0x6E79A6);
}
