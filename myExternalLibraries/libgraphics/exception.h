...
/*
 * Function: LibRaiseException
 * Usage: LibRaiseException(&e, name, value);
 * ---------------------------------------
...
void LibRaiseException(exception *e, string name, void *value);
...
#define raise(e) LibRaiseException(&e, #e, NULL)
